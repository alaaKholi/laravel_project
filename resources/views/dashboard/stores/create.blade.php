            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        @if (session('status'))
                        <div class="col-12">
                            <div class="alert alert-success">Store Addition : SUCCESS </div>
                        </div>
                        @else
                        <div class="col-12">
                            <div class="alert alert-danger">Store Addition : FAILED </div>
                        </div>
                        @endif
                        @endif
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Adding New Store :</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" enctype="multipart/form-data" action="{{ URL('dashboard/store/store') }}"
