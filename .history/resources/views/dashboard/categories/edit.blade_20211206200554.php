      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            @if (session('status'))
            <div class="col-12">
              <div class="alert alert-success">Category Editing : SUCCESS </div>
            </div>
            @else
            <div class="col-12">
              <div class="alert alert-danger">Category Editing : FAILED </div>
            </div>
            @endif
            @endif
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Editing {{ $category->name }} Category :</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" enctype="multipart/form-data"
              action="{{ URL('dashboard/category/update/'. $category->id ) }}">
              @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" name="icon" class="custom-file-input" value="{{ $category->icon }}"
                        id="exampleInputFile">
