...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <ul class="navbar-nav ml-auto">
    <!-- Navbar Search -->
    <li class="nav-item">
      <a class="nav-link" data-widget="navbar-search" href="{{ URL('dashboard/search') }}" role="button">
    ...
    <li class="nav-item">
      <a class="btn btn-sm btn-light-primary btn btn-info btn-lg font-weight-bolder" href="{{ route('logout') }}"
        onclick="event.preventDefault();
                                          document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"
          aria-hidden="false"></i>{{ __('Logout') }}
      </a>
